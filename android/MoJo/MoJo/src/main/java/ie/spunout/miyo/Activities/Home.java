...
import ie.spunout.miyo.Dialogs.LevelUp;
import ie.spunout.miyo.Dialogs.LowUse;
import ie.spunout.miyo.Dialogs.BadgeAwarded;
import ie.spunout.miyo.Fragments.Badges;
import ie.spunout.miyo.DataPoint;
import ie.spunout.miyo.DatabaseHandler;
import ie.spunout.miyo.Fragments.Graph;
import ie.spunout.miyo.R;
import ie.spunout.miyo.Fragments.Score;


public class Home extends FragmentActivity {
    private static final int BADGE_REQUIREMENT = 6;
    ...
    public void checkBadge(String action){
        ...
        if(timesDone > (currentBadge*BADGE_REQUIREMENT)){
